...
function Footer() {
  return (
    <div className='flex flex-col items-center p-2 text-white mt-7 bg-[#172337]'>
        ...
        <div className='flex  mt-2 justify-between mt-2'>
            ...
            <span  className='text-3xl p-2  mr-4 rounded-full border border-black text-primary shadow-md hover:bg-primary hover:text-red-500 ease-in duration-300 '>
                <TiSocialYoutube/>
            </span>
